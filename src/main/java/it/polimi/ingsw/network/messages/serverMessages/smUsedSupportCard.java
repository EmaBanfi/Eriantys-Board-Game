...
public class smUsedSupportCard extends ServerMessage{

    private int supportCardId;
    private double additionalTurnOrder;

    public smUsedSupportCard() {
    }

    public smUsedSupportCard(String message, int supportCardId, double additionalTurnOrder) {
        super(message);
