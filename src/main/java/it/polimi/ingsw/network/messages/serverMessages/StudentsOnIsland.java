...
public class StudentsOnIsland extends ServerMessage {

    private int island;
    ArrayList<StudentColor> students;

    public StudentsOnIsland() {
    }

    public StudentsOnIsland(String message, int island, ArrayList<StudentColor> students) {
        super(message);
        this.island = island;
